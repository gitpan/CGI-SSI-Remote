# This Makefile is for the CGI::SSI::Remote extension to perl.
#
...
#
#   MakeMaker ARGV: (q[INSTALLDIRS=site], q[INSTALLSITELIB=/home/sherzodr/perllib])
#
#   MakeMaker Parameters:

#	ABSTRACT_FROM => q[Remote.pm]
#	AUTHOR => q[A. U. Thor <a.u.thor@a.galaxy.far.far.away>]
#	NAME => q[CGI::SSI::Remote]
#	PREREQ_PM => {  }
#	VERSION_FROM => q[Remote.pm]
...
AR_STATIC_ARGS = cr
NAME = CGI::SSI::Remote
DISTNAME = CGI-SSI-Remote
NAME_SYM = CGI_SSI_Remote
VERSION = 0.02
VERSION_SYM = 0_02
XS_VERSION = 0.02
INST_BIN = blib/bin
...
INSTALLSITELIB = /home/sherzodr/perllib
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/CGI/SSI
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/CGI/SSI
...
TO_INST_PM = Remote.pm

PM_TO_BLIB = Remote.pm \
	$(INST_LIBDIR)/Remote.pm
...
manifypods : pure_all Remote.pm
	@$(POD2MAN) \
	Remote.pm \
	$(INST_MAN3DIR)/CGI::SSI::Remote.$(MAN3EXT)
...
Makefile : Makefile.PL $(CONFIGDEP)
	...
	$(PERL) "-I$(PERL_ARCHLIB)" "-I$(PERL_LIB)" Makefile.PL "INSTALLDIRS=site" "INSTALLSITELIB=/home/sherzodr/perllib"
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"CGI-SSI-Remote\" VERSION=\"0,02,0,0\">\n}. qq{\t<TITLE>CGI-SSI-Remote</TITLE>\n}. qq{\t<ABSTRACT>Perl extension for fetching remote SSI scripts</ABSTRACT>\n}. qq{\t<AUTHOR>A. U. Thor &lt;a.u.thor\@a.galaxy.far.far.away&gt;</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > CGI-SSI-Remote.ppd
